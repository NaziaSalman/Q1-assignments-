1. Install [Node.js](https://nodejs.org/en/), [TypeScript](https://www.typescriptlang.org/download) and
...
let quote = "A person who never made a mistake never tried anything new.";
let a = `${famous_person} once said, "${quote}"`;
console.log(a);
...
let names = ["Ayesha", "Anum", "Rabi", "Neelum"];
...
var transportation = ["Suzuki motorcycle", "Porsche", "Bicycle", "Jeep"];

console.log("I would like to own a " + transportation[0] + ".");
console.log("I would love to drive a " + transportation[1] + ".");
console.log("I enjoy riding a " + transportation[2] + " for leisure.");
console.log("I find a " + transportation[3] + " convenient for short trips.");
...
var mountains = ['K2', 'Ravi River', 'Pakistan', 'Lahore', 'Urdu'];
...
let name = "Ali";
console.log("Is name == 'Rabi'? I predict False.");
console.log(name == 'Ali');

let flag = false;
console.log("Is flag == true? I predict False.");
console.log(flag == true);

let numberOfGuests = 0;
console.log("Is numberOfGuests != 0? I predict False.");
console.log(numberOfGuests != 0);

let temperature = 70;
console.log("Is temperature < 68? I predict False.");
console.log(temperature < 68);

let modeOfTransportation = "bus";
console.log("Is modeOfTransportation == 'bus'? I predict True.");
console.log(modeOfTransportation == 'bus');
...
function make_shirt(size, message) {
    ...
    make_shirt("Large", "Life is too short to wear boring shirts");
  ...
  function make_shirt(size = "Large", message = "I love TypeScript") {
    console.log("The shirt size is " + size + " and the message on the shirt reads: '" + message + "'");
}
make_shirt(); 
make_shirt("Medium"); 
...
39. City Names: Write a function called city_country() that takes in the name
  ...
  var album2 = make_album("Queen", "A Night at the Opera", 11);
